...
<div class="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-8">
  ...
  <div class="grid gap-4 md:grid-cols-2 md:gap-8 lg:grid-cols-4">
    <Card.Root>
      ...
      <Card.Content>
        {#if logsOverviewStatistics}
          <div class="text-2xl font-bold">{logsOverviewStatistics?.total ?? 0}</div>
        {:else}
    ...
    <Card.Root>
      ...
      <Card.Content>
        {#if logsOverviewStatistics}
          <div class="text-2xl font-bold">{logsOverviewStatistics?.warn ?? 0}</div>
        {:else}
          <!-- Show skeleton loader -->
          <Skeleton class="h-[32px] w-[50px] rounded-lg" />
        {/if}
    ...
    <Card.Root>
      ...
      <Card.Content>
        {#if logsOverviewStatistics}
          <div class="text-2xl font-bold">{logsOverviewStatistics?.error ?? 0}</div>
        {:else}
          <!-- Show skeleton loader -->
          <Skeleton class="h-[32px] w-[50px] rounded-lg" />
        {/if}
    ...
    <Card.Root>
      ...
      <Card.Content>
        {#if logsOverviewStatistics}
          <div class="text-2xl font-bold">{logsOverviewStatistics?.fatal ?? 0}</div>
        {:else}
          <!-- Show skeleton loader -->
          <Skeleton class="h-[32px] w-[50px] rounded-lg" />
        {/if}
