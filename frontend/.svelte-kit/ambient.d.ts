...
declare module '$env/static/private' {
	...
	export const npm_package_dependencies__types_bcryptjs: string;
	...
	export const npm_package_dependencies__types_bcrypt: string;
...
declare module '$env/static/public' {
	...
	export const PUBLIC_BACKEND_PORT: string;
}
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_dependencies__types_bcryptjs: string;
		...
		npm_package_dependencies__types_bcrypt: string;
