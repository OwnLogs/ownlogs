...
type LayoutRouteId = RouteId | "/(home)" | "/(home)/log-in" | "/(home)/register" | "/app" | "/app/account/settings" | "/app/log-out" | "/app/logs" | "/app/logs/details" | "/app/servers" | "/app/servers/[id]" | null
